...
UninstallDisplayName=AI PICO — Clinical Question Assistant
...
Filename: "wscript.exe"; Parameters: """{app}\launch-aipico.vbs"""; Flags: postinstall skipifsilent runhidden; Description: "Launch AI PICO now"

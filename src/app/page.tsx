...
export default function Home() {
  ...
  const startOver = () => {
    ...
    setChatLog([]); setFormulation(null); setPubmed(null); setLoading(null);
  };
...
<p style="font-size:14pt"><b>${formulation.finalQuestion}</b></p>
        ...
        <main>
          ...
          {formulation && (
            <section className="card" ref={resultRef}>
              <span className="pill">Step 4 · Structured Clinical Question</span>
              <table className="pico">
                <tbody>
              ...
              <div className="final-q"><strong>{formulation.finalQuestion}</strong></div>
              <div className="row" style={{ marginTop: 12 }}>
                ...
                <button className="secondary" onClick={() => navigator.clipboard.writeText(formulation.finalQuestion)}>Copy question</button>
              </div>
            </section>
          )}
